...
| --- | --- | --- | --- |
| Luckfox Lyra | Lyra | 以 Release Assets 为准 | [查看说明](releases/202609.md) |
| Luckfox Lyra | Lyra Plus | 以 Release Assets 为准 | [查看说明](releases/202609.md) |
| Luckfox Lyra | Lyra Pi | 以 Release Assets 为准 | [查看说明](releases/202609.md) |
| Luckfox Lyra | Lyra Ultra | 以 Release Assets 为准 | [查看说明](releases/202609.md) |
| Luckfox Lyra | Lyra Zero W | 以 Release Assets 为准 | [查看说明](releases/202609.md) |
...
后续版本使用 [Release 模板](RELEASE_TEMPLATE.md) 编写更新说明，并按照 [发布检查清单](PUBLISHING.md) 复核附件和文档。
